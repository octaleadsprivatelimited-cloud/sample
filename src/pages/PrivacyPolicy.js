...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Pixel-i Studios</title>
        <meta name="description" content="Privacy Policy for Pixel-i Studios. Learn how we collect, use, and protect your personal information when you use our AI Films, VFX, and Animation services." />
        <meta name="keywords" content="privacy policy, data protection, GDPR, personal information, Pixel-i Studios, creative studio, AI films, VFX, animation" />
        <meta property="og:title" content="Privacy Policy - Pixel-i Studios" />
        <meta property="og:description" content="Privacy Policy for Pixel-i Studios. Learn how we collect, use, and protect your personal information." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.pixel-istudios.com/privacy" />
        <link rel="canonical" href="https://www.pixel-istudios.com/privacy" />
      </Helmet>
      ...
      <div className="privacy-policy-page">
        <section className="hero hero-with-image">
          ...
          <div className="hero-content">
            ...
            <p>Your privacy is important to us. Learn how Pixel-i Studios protects your personal information.</p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="legal-content">
              ...
              <div className="section">
                ...
                <p>
                  Pixel-i Studios ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href="https://www.pixel-istudios.com">www.pixel-istudios.com</a> or use our services.
                </p>
                <p>
              ...
              <div className="section">
                ...
                <ul>
                  ...
                  <li><strong>Cookies:</strong> Small text files stored on your device (see our Cookie Policy)</li>
              ...
              <div className="section">
                ...
                <ul>
                  <li>Provide AI Films, VFX, Animation, and Student's Lifebook services</li>
                  <li>Process and fulfill your requests and orders</li>
                  <li>Communicate about your projects and deliverables</li>
                ...
                <ul>
                  ...
                  <li>Notify you about new services and updates</li>
              ...
              <div className="section">
                ...
                <ul>
                  <li>Third-party vendors who assist in our operations (hosting, analytics, payment processing)</li>
              ...
              <div className="section">
                ...
                <ul>
                  ...
                  <li>Visit our Cookie Policy for detailed information</li>
                </ul>
              </div>
              ...
              <div className="section">
                ...
                <ul>
                  <li><strong>Active Clients:</strong> Information is retained while you have an active relationship with us</li>
                  <li><strong>Legal Requirements:</strong> Some data may be retained longer to comply with legal obligations</li>
                  <li><strong>Marketing:</strong> Marketing data is retained until you opt-out or request deletion</li>
              ...
              <div className="section">
                ...
                <p>Your continued use of our services after any modifications constitutes acceptance of the updated Privacy Policy.</p>
              </div>
              ...
              <div className="section">
                ...
                <p>This Privacy Policy complies with applicable data protection laws, including:</p>
                <ul>
                  ...
                  <li><strong>PDPA:</strong> Personal Data Protection Act (India)</li>
                  <li><strong>Other applicable local laws</strong></li>
                </ul>
              </div>
            </div>
          </div>
