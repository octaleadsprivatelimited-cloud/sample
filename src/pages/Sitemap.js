...
const Sitemap = () => {
  const mainPages = [
    {
      title: "Home",
      url: "/",
      description: "Pixel-i studios homepage - AI Films, VFX, Animation, and Student's Lifebook services"
    },
    {
      title: "About Us",
      url: "/about",
      description: "Learn about Pixel-i studios - our vision, mission, and expertise in AI Films, VFX, and Animation"
    },
    {
      title: "Our Services",
      url: "/services",
    ...
    },
    {
      title: "Contact Us",
      url: "/contact",
      description: "Get in touch with Pixel-i studios for your AI Films, VFX, and Animation projects"
    }
  ];
  ...
  const legalPages = [
    {
      ...
      url: "/privacy",
      description: "Privacy Policy for Pixel-i studios - data protection and privacy information"
    },
    {
      title: "Terms of Service",
      url: "/terms",
      description: "Terms of Service for Pixel-i studios - terms and conditions for using our services"
    },
    {
      title: "Cookie Policy",
      url: "/cookies",
      description: "Cookie Policy for Pixel-i studios - information about cookies and tracking technologies"
    },
    {
      title: "Sitemap",
      url: "/sitemap",
      description: "Complete sitemap of Pixel-i studios website structure and navigation"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Sitemap - Pixel-i studios</title>
        <meta name="description" content="Complete sitemap of Pixel-i studios website. Find all pages including AI Films, VFX, Animation services, and company information." />
        <meta name="keywords" content="sitemap, website navigation, Pixel-i studios, creative studio, AI films, VFX, animation, student lifebook, site structure" />
        <meta property="og:title" content="Sitemap - Pixel-i studios" />
        <meta property="og:description" content="Complete sitemap of Pixel-i studios website. Find all pages and services." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.pixel-istudios.com/sitemap" />
        <link rel="canonical" href="https://www.pixel-istudios.com/sitemap" />
      </Helmet>
      ...
      <div className="sitemap-page">
        <section className="hero hero-with-image">
          ...
          <div className="hero-content">
            <h1>Sitemap</h1>
            <p>Navigate through all pages and services of Pixel-i studios</p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="sitemap-content">
              <div className="sitemap-intro">
                ...
                <p>
                  Welcome to the Pixel-i studios sitemap. This page provides a comprehensive overview of all pages and sections available on our website. Use this sitemap to easily navigate to any section or service you're interested in.
                </p>
                <p>
              ...
              <div className="sitemap-section">
                ...
                <div className="company-info">
                  <div className="info-block">
                    <h3>About Pixel-i studios</h3>
                    <p>Pixel-i studios (VISUALIZE YOUR IDEA) is a pioneering creative studio specializing in AI Films, VFX, Animation, and Student's Lifebook services.</p>
